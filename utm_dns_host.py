...
options:
    ...
    macs:
        type: str
        description:
          - One or more MAC addresses as array
    comment:
        type: str
        description:
...
def main():
    ...
    key_to_check_for_changes = ["comment", "hostnames", "interface"]
    module = UTMModule(
        argument_spec=dict(
            ...
            hostnames=dict(type='list', required=False),
            macs=dict(type='list', required=False),
